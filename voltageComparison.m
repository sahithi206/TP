...
global V_without_DG V_with_DG ploss x_opt fval;

plotVoltageComparison(V_without_DG, V_with_DG, bus_numbers);
disp(['Annual energy loss Before Placing DGs: ', num2str(ploss), ' MWh']);
...
plot(bus_numbers, V_without_DG(bus_numbers), '-', 'Color', [0 0.447 0.741], ...  
    'LineWidth', 2, 'DisplayName', 'Without DG');
plot(bus_numbers, V_with_DG(bus_numbers), '-', 'Color', [0.85 0.325 0.098], ...   
